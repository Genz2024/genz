...
class CommentPage extends StatefulWidget {
  ...
  final ValueChanged<int> onCommentAdded; // New parameter
...
class _CommentPageState extends State<CommentPage> {
  ...
  void addComment(String commentText, {String? imageUrl}) {
    setState(() {
      ...
      replyingTo = null;
      widget.onCommentAdded(commentsList.length); // Notify about new comment count
    });
  }
  ...
  void deleteComment(int index) {
    setState(() {
      ...
      widget.onCommentAdded(commentsList.length); // Update comment count after deletion
    });
  }
      ...
      builder: (BuildContext context) {
        return SafeArea(
          child: Column(
            ...
            children: <Widget>[
              ListTile(
                leading: Icon(Icons.copy, color: Color(0xFF9872EB)),
              ...
              ListTile(
                leading: Icon(Icons.visibility_off, color: Color(0xFF9872EB)),
                title: Text('Hide', style: TextStyle(color: Colors.white)),
                onTap: () {
                  hideComment(index);
                  Navigator.pop(context);
                },
              ...
              ListTile(
                leading: Icon(Icons.delete, color: Color(0xFF9872EB)),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        if (widget.imageUrl != null && widget.imageUrl!.isNotEmpty) // Check if imageUrl is not null or empty
                          ClipRRect(
                        ...
                        SizedBox(height: 5),
                        // Likes text separate from the description
                        Row(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Text('Reply', style: TextStyle(color: Color(0xFF9872EB))),
                                    ),
                                  ],
                                ),
                              ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  icon: Icon(Icons.gif, color: Color(0xFF9872EB)),
                  onPressed: pickGif,
                ),
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon: IconButton(
                        icon: Icon(Icons.emoji_emotions, color: Color(0xFFE871C5)),
                ...
                IconButton(
                  icon: Icon(Icons.send, color: Color(0xFFE871C5)),
                  onPressed: () {
